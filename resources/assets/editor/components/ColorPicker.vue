...
<template>
  <ColorPicker.Root
    ...
    <ColorPicker.Control class="flex gap-2">
      ...
      <ColorPicker.ChannelInput channel="hex" class="appearance-none rounded bg-none outline-0 relative w-full border px-3 h-10 min-w-10 focus:ring focus:ring-gray-700" />
    ...
    <ColorPicker.Positioner class="w-60 !z-20 pl-1">
      <ColorPicker.Content class="flex flex-col p-4 gap-3 rounded bg-white border shadow-sm data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-out data-[state=closed]:hidden">
        ...
        <ColorPicker.View format="rgba" class="flex gap-3">
          <ColorPicker.ChannelInput channel="hex" class="flex-1 border px-3 h-8 w-0 rounded outline-0 focus:ring focus:ring-gray-700" />
          <ColorPicker.ChannelInput channel="alpha" class=" flex-none border px-3 h-8 rounded outline-0 focus:ring focus:ring-gray-700" />
        </ColorPicker.View>
