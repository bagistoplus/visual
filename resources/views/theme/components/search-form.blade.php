<button class="p-2" aria-label="Search" @click="showSearch = !showSearch">
  <x-lucide-search class="hover:text-primary h-5 w-5 transition-colors" />
</button>

<div x-cloak x-show="showSearch" class="bg-surface border-surface-600 absolute -left-4 right-0 top-16 border-b shadow-lg"
