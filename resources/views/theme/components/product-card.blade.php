...
<div x-data="{ mode: 'grid', isMobile: window.innerWidth < 640, }" x-modelable="mode" {{ $attributes }}>
  <span></span>
  <div x-cloak x-show="mode === 'grid' || isMobile"
    ...
    <div class="relative aspect-square overflow-hidden rounded-t-lg">
      ...
      <div class="absolute inset-0 bg-black/40 opacity-0 transition-opacity group-hover:opacity-100">
        ...
        <div
          ...
          <livewire:add-to-cart-button :productId="$product->id" wire:key="{{ str()->random(16) }}" simple />
    ...
    <div class="flex flex-1 flex-col justify-between p-6">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          <div class="text-primary flex items-center gap-2 text-xl font-medium">
            {!! $product->getTypeInstance()->getPriceHtml() !!}
          </div>
