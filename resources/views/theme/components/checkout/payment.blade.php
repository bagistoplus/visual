...
<div>
  ...
  <div class="mt-4 space-y-4">
    @foreach ($paymentMethods as $paymentMethod)
      <label
        class="has-[:checked]:border-primary has-[:checked]:bg-primary-50 block cursor-pointer rounded-lg border-2 border-gray-200 p-4 transition-colors hover:border-gray-300"
      >
