<div class="bg-background min-h-screen py-12">
  <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-4">
          <div class="flex gap-4">
            <div class="h-20 w-20 flex-shrink-0 overflow-hidden rounded-lg bg-gray-100"><img
                src="https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?auto=format&amp;fit=crop&amp;q=80&amp;w=300"
                alt="Rose Quartz Face Serum"
                class="h-full w-full object-cover"
              ></div>
            <div class="flex-1">
              <h3 class="text-secondary font-medium">Rose Quartz Face Serum</h3>
              <p class="text-secondary text-sm">Quantity: 2</p>
              <p class="text-primary text-sm">$48.00</p>
            </div>
          </div>
          <div class="flex gap-4">
            <div class="h-20 w-20 flex-shrink-0 overflow-hidden rounded-lg bg-gray-100"><img
                src="https://images.unsplash.com/photo-1556229174-5e42a09e45af?auto=format&amp;fit=crop&amp;q=80&amp;w=300"
                alt="Bamboo Face Cream"
                class="h-full w-full object-cover"
              ></div>
            <div class="flex-1">
              <h3 class="text-secondary font-medium">Bamboo Face Cream</h3>
              <p class="text-secondary text-sm">Quantity: 1</p>
              <p class="text-primary text-sm">$53.97</p>
            </div>
          </div>
        </div>
        <div class="border-t border-gray-200 pt-4">
          <div class="space-y-2">
            <div class="text-secondary flex justify-between"><span>Subtotal</span><span>$149.97</span></div>
            <div class="text-secondary flex justify-between"><span>Shipping</span><span>Free</span></div>
            <div class="flex justify-between border-t border-gray-200 pt-2 text-lg font-medium"><span>Total</span><span
                class="text-primary"
              >$149.97</span></div>
          </div>
        </div>
    ...
    {{-- <div class="mb-8 rounded-lg bg-white p-6 shadow-sm">
      <div class="text-secondary mb-4 flex items-center gap-3">
        <x-lucide-package class="h-5 w-5" />
        <h2 class="font-medium">Shipping Information</h2>
      </div>
      <p class="text-secondary mb-2">Estimated delivery: 3-5 business days</p>
      <p class="text-secondary text-sm">You will receive shipping confirmation and tracking number when your order
        ships.</p>
    </div> --}}
